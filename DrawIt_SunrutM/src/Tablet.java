...
//Checks the arrow keys pressed periodically (every 5ms) and uses the arrow to determine the direction the pointer goes in
//Pointer leaves a drawn trail on the tablet, which can be reset with space bar.
